...
Замечание: Возможно смонтировать локальную директорию, как cdrom. Аппаратная 
  ...
  дискам, кроме CD-ROMs (благодаря их особенности "только чтение"). В противном случае при возникновении ошибки в DOSBox, вы можете потерять все ваши файлы.
  Рекомендуется положить ваши приложения/игры в поддиректорию и монтировать ее.
